...
const icons = {
  ...
  ,logout: { viewBox: '0 0 16 16', body: '<path d="M7 3.5H5.5C3.84315 3.5 2.5 4.84315 2.5 6.5V9.5C2.5 11.1569 3.84315 12.5 5.5 12.5H7" stroke="currentColor" fill="none"/><path d="M5.5 8.5V7.5C5.5 6.94772 5.94772 6.5 6.5 6.5H9.5V5.91421C9.5 5.02331 10.5771 4.57714 11.2071 5.20711L14 8L11.2071 10.7929C10.5771 11.4229 9.5 10.9767 9.5 10.0858V9.5H6.5C5.94772 9.5 5.5 9.05228 5.5 8.5Z" stroke="currentColor" fill="none"/>' }
}
