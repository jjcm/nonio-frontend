...
const icons = {
  ...
  ,settings: { viewBox: '0 0 16 16', body: '<circle cx="8" cy="8" r="2.5" stroke="currentColor" fill="none"/><path d="M8 1.5V4M8 12V14.5M3.5 8H1.5M14.5 8H12M3.4 3.4L5.17157 5.17157M10.8284 10.8284L12.6 12.6M12.6 3.4L10.8284 5.17157M5.17157 10.8284L3.4 12.6" stroke="currentColor" stroke-linecap="round"/>' }
}
